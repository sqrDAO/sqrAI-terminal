...
<path fill-rule="evenodd" clip-rule="evenodd" d="M3.66634 1.8335H1.83301V9.16683H3.66634V1.8335ZM18.3333 1.8335H20.1666V9.16683H18.3333V1.8335ZM12.8329 7.33344H9.16643V1.8335H7.33323H7.33309H3.66656V3.66683H7.33309V7.33344H3.66656V9.16677H7.33309V12.8334H3.66656V14.6668H7.33309V18.3335H3.66656V20.1668H7.33309V20.1668H9.16643V14.6668H12.8329V20.1668H14.6662V14.6668H18.3332V12.8334H14.6662V9.16677H18.3332V7.33344H14.6662V1.8335H12.8329V7.33344ZM9.16643 12.8334V9.16677H12.8329V12.8334H9.16643ZM18.3331 1.8335H14.6664V3.66683H18.3331V1.8335ZM1.83301 12.8334H3.66634V20.1668H1.83301V12.8334ZM14.6664 18.3335H18.3331V20.1668H14.6664V18.3335ZM20.1666 12.8334H18.3333V20.1668H20.1666V12.8334Z" fill="${
  ...
  const agentFunctionalitiesMenu = [
    {
      href: "/github",
    ...
    },
    {
      ...
      label: "Schedule",
      icon: `<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
<path fill-rule="evenodd" clip-rule="evenodd" d="M13.75 1.83398H15.5833V3.66732H17.4167H19.25V5.50065V7.33398V9.16732V18.334V20.1673H17.4167H4.58333H2.75V18.334V9.16732V7.33398V5.50065V3.66732H4.58333H6.41667V1.83398H8.25V3.66732H13.75V1.83398ZM8.25 5.50065H6.41667H4.58333V7.33398H17.4167V5.50065H15.5833H13.75H8.25ZM4.58333 9.16732V18.334H17.4167V9.16732H4.58333ZM6.41667 11.0007H8.25V12.834H6.41667V11.0007ZM11.9167 11.0007H10.0833V12.834H11.9167V11.0007ZM13.75 11.0007H15.5833V12.834H13.75V11.0007ZM8.25 14.6673H6.41667V16.5007H8.25V14.6673ZM10.0833 14.6673H11.9167V16.5007H10.0833V14.6673ZM15.5833 14.6673H13.75V16.5007H15.5833V14.6673Z" fill="${
        ...
        <div className="w-80 h-[calc(100vh_-77px)] pt-3 border-r border-[#dcff9f] flex-col justify-start items-start gap-3 inline-flex bg-black relative z-[100] overflow-hidden">
            ...
            <div className="self-stretch h-[46px] flex-col justify-start items-start gap-1 flex">
              {menuList.map((menu, index) => (
                <Link
                  key={index}
                  href={menu?.href}
                  className={`self-stretch px-3.5 py-3 justify-center items-center gap-3 inline-flex ${pathName === menu?.href ? "bg-[#A4FB0E] text-black" : "bg-transparent text-white"}`}
                  onClick={() => setIsSidebarVisible(false)}
                >
                  <div dangerouslySetInnerHTML={{ __html: menu?.icon }} />
                  <div className={`grow shrink basis-0 text-base font-medium font-bricolage leading-snug`}>{menu?.label}</div>
                </Link>
              ))}
            </div>
          </div>
          ...
          <div className="self-stretch px-3 flex-col justify-start items-start flex">
            ...
            <div className="self-stretch flex-col justify-start items-start gap-1 flex pb-2">
              {buidKnowledgeMenu.map((menu, index) => (
                <Link
                  key={index}
                  href={menu?.href}
                  className={`self-stretch px-3.5 py-3 justify-center items-center gap-3 inline-flex ${pathName === menu?.href ? "bg-[#A4FB0E] text-black" : "bg-transparent text-white"}`}
                ...
                >
                  <div dangerouslySetInnerHTML={{ __html: menu.icon }} />
                  <div className={`grow shrink basis-0 text-base font-medium font-bricolage leading-snug flex w-full justify-between items-baseline ${menu?.disabled ? "text-[#666666]" : ""}`}>
                    {menu?.label}
                    {menu?.disabled && <div className="text-xs font-bricolage text-[#A4FB0E]">Coming soon</div>}
                  </div>
                </Link>
              ))}
            </div>
          ...
          <div className="self-stretch h-[94px] px-3 flex-col justify-start items-start flex">
            ...
            <div className="self-stretch h-[46px] flex-col justify-start items-start gap-1 flex">
              {agentFunctionalitiesMenu.map((menu, index) => (
                <Link
                  key={index}
                  href={menu?.href}
                  className={`self-stretch px-3.5 py-3 justify-center items-center gap-3 inline-flex ${pathName === menu?.href ? "bg-[#A4FB0E] text-black" : "bg-transparent text-white"}`}
