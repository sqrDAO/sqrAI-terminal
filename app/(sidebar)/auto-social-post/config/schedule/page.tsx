            ...
            <table className="self-stretch h-[300px] w-[936px] border-collapse">
              <thead>
                <tr className="border-b border-[#444444]">
                  <th className="px-5 py-2.5 text-left text-[#999999] text-sm font-semibold font-bricolage leading-tight">
                    Name
                  </th>
                  <th className="px-5 py-2.5 text-left text-[#999999] text-sm font-semibold font-bricolage leading-tight">
                  ...
                  <th className="px-5 py-2.5 text-right text-[#999999] text-sm font-semibold font-bricolage leading-tight">
                    Action
                  </th>
                </tr>
              </thead>
                ...
                {["Morning post", "Morning post", "Morning post"].map(
                  (post, index) => (
                    <tr key={index} className="border-b border-[#444444]">
                      ...
                      <td className="px-5 py-4 text-[#999999] text-sm font-semibold font-bricolage leading-tight flex justify-end">
