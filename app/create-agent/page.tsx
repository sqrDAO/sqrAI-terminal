      ...
      <div className="self-stretch grow shrink basis-0 p-6 justify-between items-start inline-flex">
        <div className="grow shrink basis-0 self-stretch pl-16 pt-[132px] flex-col justify-start items-start gap-2.5 inline-flex">
          <div className="self-stretch justify-center items-center gap-4 inline-flex">
            ...
            <div className="grow shrink basis-0 text-white text-3xl font-medium font-['Chakra Petch'] leading-[37.50px]">Create a agent</div>
          </div>
          <div className="self-stretch justify-start items-start gap-2.5 inline-flex">
            <div className="w-[1318px] pl-12 pt-[122px] flex-col justify-start items-start gap-6 inline-flex">
              <div className="self-stretch text-white text-5xl font-semibold font-['Chakra Petch'] leading-[60px]">Let's start with a name for your agent</div>
              <div className="h-[72px] flex-col justify-start items-start gap-1.5 flex">
                <div className="self-stretch h-[72px] flex-col justify-start items-start gap-2 flex">
                  <div className="self-stretch h-5 flex-col justify-start items-start gap-1 flex">
                    <div className="self-stretch text-white text-sm font-semibold font-['Bricolage Grotesque'] leading-tight">Agent name</div>
                  </div>
                  <Input
                    value={agentName}
                    onChange={(e) => {
              ...
              <div className="self-stretch justify-start items-center gap-6 inline-flex">
                <div className="justify-start items-center gap-1.5 flex">
                  <div className="text-[#888888] text-sm font-semibold font-['Bricolage Grotesque'] leading-tight">Agent id</div>
                  <Image src={"/icons/info-icon.svg"} alt={""} width={18} height={18}></Image>
                </div>
                <div className="text-white text-sm font-semibold font-['Bricolage Grotesque'] leading-tight">your-project-id</div>
              </div>
        ...
        <div className="w-[368px] self-stretch p-6 border border-[#dcff9f] flex-col justify-between items-start inline-flex">
          <div className="text-[#a4fb0e] text-xl font-medium font-['Bricolage Grotesque'] leading-[27px] animate-blink">{">"}_</div>
